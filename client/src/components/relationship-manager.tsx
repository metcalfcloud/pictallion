...
const getRelationshipDisplayText = (
  ...
  const otherPerson = isCurrentPersonPerson1
...
export function RelationshipManager({
  ...
  const handleAddRelationship = () => {
    if (!selectedPersonId || !relationshipType) {
      toast({
        title: 'Please select a person and relationship type',
        variant: 'destructive',
      });
      return;
    }
          ...
          {relationships.length === 0 ? (
            ...
            <div className="space-y-3">
              {relationships.map((relationship: Relationship) => {
                const { label, otherPerson } = getRelationshipDisplayText(
                  relationship,
                  personId,
                );
                return (
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Define how {personName} is related to another person. For example,
              selecting "Parent of" means {personName} is the parent of the selected
              person.
            </DialogDescription>
          </DialogHeader>
