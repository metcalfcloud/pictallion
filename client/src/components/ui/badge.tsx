  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:scale-105",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground border-border bg-background/50 backdrop-blur-sm hover:bg-accent hover:text-accent-foreground",
        success:
        ...
        gold:
          "border-transparent bg-gradient-to-r from-yellow-400 to-yellow-600 text-white shadow-sm hover:shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
