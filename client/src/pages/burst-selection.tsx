...
export default function BurstSelectionPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-semibold">Burst Photo Selection</h2>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button
            ...
            disabled={processing || totalSelectedCount === 0}
          >
            <ArrowRight className="w-4 h-4 mr-2" />
            Process Selections ({totalSelectedCount})
          </Button>
        </div>
      </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium">Burst Groups</p>
                <p className="text-2xl font-bold">{analysis.groups.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium">Selected for Processing</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{analysis.totalPhotos}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {analysis.ungroupedPhotos.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Individual Photos</CardTitle>
            <CardDescription>
