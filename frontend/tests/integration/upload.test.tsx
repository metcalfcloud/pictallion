...
describe("Upload Integration Tests", () => {
  ...
  describe("Successful Upload Flow", () => {
    it("should successfully upload a photo through Tauri API", async () => {
      ...
      // Create a mock file
      const file = new File(["test content"], "test-photo.jpg", {
        type: "image/jpeg",
      });
    ...
    it("should handle drag and drop upload", async () => {
      ...
      const file = new File(["test content"], "dropped-photo.jpg", {
        type: "image/jpeg",
      });
      const dropZone = screen.getByLabelText(
        /drag and drop image upload area/i,
      );
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Selected: dropped-photo.jpg"),
        ).toBeInTheDocument();
      });
    ...
    it("should show loading state during upload", async () => {
      ...
      const file = new File(["test content"], "slow-upload.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      await userEvent.upload(fileInput, file);
  ...
  describe("Error Handling", () => {
    it("should handle Tauri API errors gracefully", async () => {
      ...
      const file = new File(["test content"], "error-photo.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      await userEvent.upload(fileInput, file);
      ...
      await waitFor(() => {
        expect(
          screen.getByText(
            /failed to upload photo.*network connection failed/i,
          ),
        ).toBeInTheDocument();
      });
    ...
    it("should handle file system permission errors", async () => {
      ...
      const file = new File(["test content"], "permission-error.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      await userEvent.upload(fileInput, file);
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/failed to upload photo.*permission denied/i),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should handle invalid file format errors", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/failed to upload photo.*unsupported file format/i),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should handle Tauri runtime not available", async () => {
      ...
      const file = new File(["test content"], "no-tauri.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      await userEvent.upload(fileInput, file);
      ...
      await waitFor(() => {
        expect(
          screen.getByText(
            /failed to upload photo.*tauri runtime not available/i,
          ),
        ).toBeInTheDocument();
      });
    });
  ...
  describe("UI State Management", () => {
    ...
    it("should enable upload button when file is selected", async () => {
      ...
      const file = new File(["test content"], "enable-test.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      await userEvent.upload(fileInput, file);
    ...
    it("should disable upload button during upload", async () => {
      ...
      const file = new File(["test content"], "disable-test.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      await userEvent.upload(fileInput, file);
    ...
    it("should show preview image when file is selected", async () => {
      ...
      const file = new File(["test content"], "preview-test.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      await userEvent.upload(fileInput, file);
    ...
    it("should clear error messages when new file is selected", async () => {
      ...
      const file1 = new File(["test content"], "error-file.jpg", {
        type: "image/jpeg",
      });
      const fileInput = screen.getByLabelText(/image file input/i);
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/failed to upload photo.*test error/i),
        ).toBeInTheDocument();
      });

      // Select new file
      const file2 = new File(["test content"], "new-file.jpg", {
        type: "image/jpeg",
      });
      ...
      expect(
        screen.queryByText(/failed to upload photo/i),
  ...
  describe("Accessibility", () => {
    it("should have proper ARIA labels", () => {
      ...
      expect(
        screen.getByLabelText(/drag and drop image upload area/i),
      ).toBeInTheDocument();
      expect(
        screen.getByLabelText(/select image to upload/i),
      ).toBeInTheDocument();
      expect(
        screen.getByLabelText(/upload selected image/i),
      ).toBeInTheDocument();
