...
describe('Tauri API Integration Tests', () => {
  ...
  describe('Photo Management', () => {
    ...
    it('should handle add photo errors', async () => {
      ...
      await expect(addPhoto('/invalid/path.jpg')).rejects.toThrow('File not found');
    ...
    it('should promote photo tier', async () => {
      ...
      expect(callHistory[0].args).toEqual({ photoId: 'photo-123', tier: 'silver' });
    });
    ...
    it('should promote photo (alternative method)', async () => {
      ...
      expect(callHistory[0].args).toEqual({ photoId: 'photo-123', tier: 'gold' });
    });
  });
  ...
  describe('People Management', () => {
    ...
    it('should update person', async () => {
      ...
      expect(callHistory[0].args).toEqual({ personId: 'person-123', req: updateRequest });
    });
  ...
  describe('Face Detection', () => {
    ...
    it('should generate face embedding', async () => {
      ...
      const result = await generateFaceEmbedding('/path/to/image.jpg', boundingBox);
    ...
    it('should handle face detection errors', async () => {
      ...
      await expect(detectFaces('/invalid/path.jpg')).rejects.toThrow('Face detection service unavailable');
  ...
  describe('Error Handling and Edge Cases', () => {
    it('should handle network timeouts', async () => {
      ...
      await expect(addPhoto('/path/to/photo.jpg')).rejects.toThrow('Request timeout');
    });
  ...
  describe('Performance and Reliability', () => {
    it('should handle large data responses', async () => {
      ...
      expect(result[0]).toEqual({ id: 'photo-0', filePath: '/path/photo0.jpg', tier: 'gold' });
      expect(result[999]).toEqual({ id: 'photo-999', filePath: '/path/photo999.jpg', tier: 'bronze' });
    });
