...
from app.models import (
    MediaAsset, FileVersion, Person, Face, Collection, 
    User, Setting, Event, Relationship, Location
)
...
class TestDataGenerator:
    ...
    @staticmethod
    def generate_test_image(width: int = 100, height: int = 100, color: str = 'red') -> Image.Image:
    ...
    def generate_ai_metadata() -> Dict[str, Any]:
        ...
        tags = ["portrait", "landscape", "urban", "nature", "people", "animals", "architecture"]
        return {
...
class PerformanceTestHelper:
    ...
    @staticmethod
    async def run_concurrent_operations(async_func, operations: List[tuple], max_concurrent: int = 10):
        ...
        tasks = [
            run_with_semaphore(args, kwargs) 
...
TEST_RELATIONSHIP_TYPES = ["spouse", "partner", "sibling", "parent", "child", "friend", "relative"]
