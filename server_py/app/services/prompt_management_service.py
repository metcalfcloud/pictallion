...
PROMPT_CATEGORIES = [
    {"id": "analysis", "name": "Image Analysis", "description": "General image analysis and description"},
    {"id": "family", "name": "Family Photos", "description": "Family-focused descriptions and analysis"},
    {"id": "objects", "name": "Object Detection", "description": "Object and item identification"},
    {"id": "events", "name": "Event Detection", "description": "Event and occasion identification"},
    {"id": "locations", "name": "Location Analysis", "description": "Location and setting analysis"}
]
...
class PromptManagementService:
    ...
    async def update_prompt(self, prompt_id: str, updates: AIPromptUpdate) -> Optional[AIPrompt]:
        """
    ...
    async def generate_family_description(self, people_context: List[Dict[str, Any]]) -> str:
        """
