...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="sqlite:///./data/pictallion.db", alias="DATABASE_URL"
    )
    ...
    ollama_text_model: str = Field(default="llama3.2:latest", alias="OLLAMA_TEXT_MODEL")
    ...
    allowed_file_types: str = Field(
        default="jpg,jpeg,png,gif,webp", alias="ALLOWED_FILE_TYPES"
    )

    # Security Configuration
    secret_key: str = Field(
        default="your-secret-key-change-in-production", alias="SESSION_SECRET"
    )
