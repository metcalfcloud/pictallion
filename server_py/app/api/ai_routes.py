...
async def analyze_image(
    ...
    try:
        ...
        if request.include_people_context:
            ...
            people_context: List[Dict[str, Any]] = await ai_service.build_people_context(faces, crud)
        ...
        return AIAnalysisResponse(
            ...
            confidence_scores=enhanced_analysis.get("ai_confidence_scores", {}) if isinstance(enhanced_analysis, dict) else {},
        ...
        for photo_id in photo_ids:
            try:
                ...
                await crud.update_file_version(photo_id, {
                    ...
                    "ai_short_description": enhanced_analysis.get("short_description") if isinstance(enhanced_analysis, dict) else None,
                    "is_reviewed": False
                })
...
async def generate_ai_filename(
    ...
    try:
        ...
        filename = f"{pattern}_{photo_id}_{tier}"  # Fallback: generate filename manually
...
async def enhance_description(
    ...
    try:
        ...
        enhanced = f"{base_description} (enhanced)"  # Fallback: manually enhance description
