...
async def get_collection_photos(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch collection photos: {str(e)}"
        )
...
async def remove_photos_from_collection(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to remove photos: {str(e)}"
        )
...
async def list_smart_collections(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get smart collections: {str(e)}"
        )
...
async def create_smart_collection(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create smart collection: {str(e)}"
        )
...
async def toggle_smart_collection(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to toggle smart collection: {str(e)}"
        )
...
async def organize_smart_collections(
    ...
    try:
        ...
        collections = await crud.get_collections()
        smart_collections = [
            c for c in collections if c.is_smart_collection and c.is_public
        ]
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to organize smart collections: {str(e)}"
        )
...
async def get_smart_collection_photos(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to fetch smart collection photos: {str(e)}"
        )
    ...
    try:
        ...
        if photos:
            ...
            for photo in photos:
                ...
                ext = (
                    photo.file_path.split(".")[-1].lower()
                    if "." in photo.file_path
                    else "unknown"
                )
