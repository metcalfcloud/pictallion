...
def upgrade() -> None:
    ...
    op.create_table('users',
        sa.Column('id', sa.VARCHAR(), nullable=False, server_default=sa.text('gen_random_uuid()')),
    ...
    op.create_table('file_versions',
        ...
        sa.Column('processing_state', sa.TEXT(), nullable=True, server_default="'processed'"),
        sa.Column('created_at', sa.TIMESTAMP(), nullable=False, server_default=sa.text('NOW()')),
    ...
    op.create_table('collections',
        ...
        sa.Column('is_smart_collection', sa.BOOLEAN(), nullable=True, server_default='false'),
        sa.Column('smart_rules', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('created_at', sa.TIMESTAMP(), nullable=False, server_default=sa.text('NOW()')),
    ...
    op.create_table('locations',
        ...
        sa.Column('is_user_defined', sa.BOOLEAN(), nullable=True, server_default='false'),
    ...
    op.create_table('global_tag_library',
        sa.Column('id', sa.VARCHAR(), nullable=False, server_default=sa.text('gen_random_uuid()')),
    ...
    op.create_index(op.f('ix_global_tag_library_tag'), 'global_tag_library', ['tag'], unique=True)
    op.create_index('idx_global_tag_library_usage', 'global_tag_library', ['usage_count'], postgresql_using='btree')
    ...
    op.create_table('collection_photos',
        ...
        sa.ForeignKeyConstraint(['photo_id'], ['file_versions.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
